...
import com.facade.EstadoSolicitudFacade;
...
@Named("estadoSolicitudController")
@SessionScoped
public class EstadoSolicitudController implements Serializable {
    ...
    @EJB
    private com.facade.EstadoSolicitudFacade ejbFacade;
    ...
    public EstadoSolicitud getEstadoSolicitud(java.lang.Integer id) {
    ...
    public static class EstadoSolicitudControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getEstadoSolicitud(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EstadoSolicitud) {
                ...
                return getStringKey(o.getIDEstadoSolicitudd());
            } else {
