...
public class TipoMovimientoController implements Serializable {
    ...
    @EJB
    private com.facade.TipoMovimientoFacade ejbFacade;
    ...
    public static class TipoMovimientoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoMovimiento) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TipoMovimiento.class.getName());
            }
        }
